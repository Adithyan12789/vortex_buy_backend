...
const lf = (keyword, lock) => {
    const url = `https://loremflickr.com/600/800/${keyword}?lock=${lock}`;
    return {
        items: [{ image: { url } }, { image: { url: url.replace('lock=', 'lock=alt-') } }],
        mainMedia: { image: { url } }
    };
};
...
async function seed() {
    try {
        ...
        await Category.insertMany([
            ...
            { name: 'Home & Kitchen',slug: 'home-kitchen', media: { mainMedia: { image: { url: 'https://loremflickr.com/600/800/kitchen?lock=999' } } } },
            { name: 'Sports',        slug: 'sports',       media: { mainMedia: { image: { url: 'https://loremflickr.com/600/800/fitness?lock=888' } } } },
        ]);
        ...
        await Product.insertMany([
            ...
            // HOME & KITCHEN
            { name: 'Pour-Over Coffee Set',        slug: 'pour-over-coffee-set',        categorySlug: 'home-kitchen', price: { price: 1899, discountedPrice: 1499 }, stock: { quantity: 50  }, media: lf('coffee,pot', 101),  additionalInfoSections: d('Borosilicate glass dripper with reusable steel filter.') },
            { name: 'Ceramic Dinner Set 16pc',     slug: 'ceramic-dinner-set-16pc',     categorySlug: 'home-kitchen', price: { price: 2499, discountedPrice: 1999 }, stock: { quantity: 30  }, media: lf('dinner,set', 102),  additionalInfoSections: d('16-piece hand-glazed ceramic, microwave & dishwasher safe.') },
            { name: 'Bamboo Cutting Board',        slug: 'bamboo-cutting-board',        categorySlug: 'home-kitchen', price: { price: 799,  discountedPrice: 599  }, stock: { quantity: 90  }, media: lf('chopping,board', 103),  additionalInfoSections: d('Eco-friendly bamboo with juice groove and side handle.') },
            { name: 'Scented Soy Candle Set',      slug: 'scented-soy-candle-set',      categorySlug: 'home-kitchen', price: { price: 1299, discountedPrice: 999  }, stock: { quantity: 80  }, media: lf('candle', 104),  additionalInfoSections: d('Set of 3 — lavender, vanilla, sandalwood, 40-hr burn.') },
            { name: 'Cast Iron Skillet 10"',       slug: 'cast-iron-skillet-10',        categorySlug: 'home-kitchen', price: { price: 2999, discountedPrice: 2299 }, stock: { quantity: 40  }, media: lf('skillet,pan', 105),  additionalInfoSections: d('Pre-seasoned cast iron, oven-safe up to 500°F.') },
            { name: 'Electric Kettle 1.7L',        slug: 'electric-kettle-1-7l',        categorySlug: 'home-kitchen', price: { price: 1499, discountedPrice: 1099 }, stock: { quantity: 65  }, media: lf('kettle', 106),  additionalInfoSections: d('Rapid boil, keep-warm function, concealed element.') },
            { name: 'Non-Stick Cookware Set 5pc',  slug: 'non-stick-cookware-set-5pc',  categorySlug: 'home-kitchen', price: { price: 3999, discountedPrice: 2999 }, stock: { quantity: 25  }, media: lf('cookware,pot', 107),  additionalInfoSections: d('PFOA-free granite coating, induction compatible.') },
            { name: 'Vacuum Food Container Set',   slug: 'vacuum-food-container-set',   categorySlug: 'home-kitchen', price: { price: 1199, discountedPrice: 899  }, stock: { quantity: 70  }, media: lf('container,food', 108),  additionalInfoSections: d('Set of 5 airtight vacuum-seal containers with pump.') },
            { name: 'Wooden Serving Board',        slug: 'wooden-serving-board',        categorySlug: 'home-kitchen', price: { price: 1099, discountedPrice: 849  }, stock: { quantity: 55  }, media: lf('serving,board', 109),  additionalInfoSections: d('Acacia wood charcuterie & serving board with handles.') },
            { name: 'French Press Coffee Maker',   slug: 'french-press-coffee-maker',   categorySlug: 'home-kitchen', price: { price: 999,  discountedPrice: 749  }, stock: { quantity: 85  }, media: lf('frenchpress', 110),   additionalInfoSections: d('800ml borosilicate glass press with stainless steel filter.') },

            // SPORTS
            { name: 'Yoga Mat Premium 6mm',        slug: 'yoga-mat-premium-6mm',        categorySlug: 'sports',       price: { price: 999,  discountedPrice: 799  }, stock: { quantity: 100 }, media: lf('yogamat', 201),  additionalInfoSections: d('6mm non-slip mat with alignment lines and carry strap.') },
            { name: 'Resistance Band Set 5pc',     slug: 'resistance-band-set-5pc',     categorySlug: 'sports',       price: { price: 699,  discountedPrice: 499  }, stock: { quantity: 150 }, media: lf('resistanceband', 202),  additionalInfoSections: d('5 resistance levels 10–50 lbs, door anchor included.') },
            { name: 'Insulated Water Bottle 1L',   slug: 'insulated-water-bottle-1l',   categorySlug: 'sports',       price: { price: 1299, discountedPrice: 999  }, stock: { quantity: 200 }, media: lf('waterbottle', 203),  additionalInfoSections: d('Double-wall stainless — cold 24h, hot 12h, leakproof.') },
            { name: 'Adjustable Dumbbell Set',     slug: 'adjustable-dumbbell-set',     categorySlug: 'sports',       price: { price: 7999, discountedPrice: 6499 }, stock: { quantity: 20  }, media: lf('dumbbell', 204),  additionalInfoSections: d('5–52.5 lbs per dumbbell with quick-lock dial.') },
            { name: 'Jump Rope Speed',             slug: 'jump-rope-speed',             categorySlug: 'sports',       price: { price: 499,  discountedPrice: 349  }, stock: { quantity: 180 }, media: lf('jumprope', 205),  additionalInfoSections: d('Ball-bearing handles, adjustable PVC cable.') },
            { name: 'Pull-Up Bar Doorway',         slug: 'pull-up-bar-doorway',         categorySlug: 'sports',       price: { price: 1299, discountedPrice: 999  }, stock: { quantity: 60  }, media: lf('fit,horizontalbar', 206),  additionalInfoSections: d('No-screw doorway mount, foam grips, 150kg max.') },
            { name: 'Foam Roller Deep Tissue',     slug: 'foam-roller-deep-tissue',     categorySlug: 'sports',       price: { price: 799,  discountedPrice: 599  }, stock: { quantity: 90  }, media: lf('foamroller', 207),  additionalInfoSections: d('High-density EPE foam, textured surface for deep massage.') },
            { name: 'Gym Gloves Padded',           slug: 'gym-gloves-padded',           categorySlug: 'sports',       price: { price: 599,  discountedPrice: 449  }, stock: { quantity: 120 }, media: lf('gym,gloves', 208),  additionalInfoSections: d('Anti-slip palm pad, breathable mesh back, wrist wrap.') },
            { name: 'Ab Wheel Roller',             slug: 'ab-wheel-roller',             categorySlug: 'sports',       price: { price: 699,  discountedPrice: 499  }, stock: { quantity: 100 }, media: lf('abroller', 209),  additionalInfoSections: d('Dual-wheel stability, non-slip treads, knee pad included.') },
            { name: 'Sports Gym Bag 45L',          slug: 'sports-gym-bag-45l',          categorySlug: 'sports',       price: { price: 1599, discountedPrice: 1199 }, stock: { quantity: 70  }, media: lf('gymbag', 210),  additionalInfoSections: d('Wet/dry separation, shoe compartment, water-resistant base.') },
        ]);
